      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Leave Data</span>
            </a>
         </li>
         <li>
            ...
            <ul id="dropdown-config" class="hidden py-2 space-y-2">
               <li>
                  <a href="{{ route('department') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Office Location</a>
               </li>
               <li>
                  <a href="{{ route('department') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Working Hour</a>
               </li>
            </ul>
         </li>
      </ul>

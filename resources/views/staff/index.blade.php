            ...
            <form class="max-w-sm ml-4" action="{{ route('staff') }}" method="GET">
                <div class="flex flex-row items-center space-x-4 w-full">
                    <div class="w-full">
                        ...
                        <div class="flex">
                            <select id="keyword" name="filterDepartment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected disabled>Choose a department</option>
                                @foreach($departments as $department)
                                <option value="{{ $department->id }}" {{ $filterDepartment == $department->id ? 'selected' : '' }}>{{ $department->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="flex items-center justify gap-4 px-6 py-4">
                                ...
                                <a href="{{ route('staff.config', ['id' => $staff->id]) }}">
                                    <button type="button" 

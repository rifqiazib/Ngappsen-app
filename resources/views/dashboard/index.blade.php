...
@section('content')
    <div class="ml-4 mr-4 ">
        <div class="mt-4 w-full p-6 bg-zinc-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex">
                @if(Auth::check())
                    <p class="text-lg">HALO {{ Auth::user()->name }}</p>
                @endif
            ...
            <div class="flex justify-between space-x-4 mt-8">
                <div class="w-full"> 
                    <a href="#" class="block w-full p-6 bg-green-200 border border-gray-200 rounded-lg shadow hover:bg-green-300 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p class="font-normal text-gray-700 dark:text-gray-400">{{ $attedance != null && $attedance->entry_time != null ? $attedance->entry_time : "Belum Absen" }}</p>
                    </a>
                </div>
                <div class="w-full"> 
                    <a href="#" class="block w-full p-6 bg-red-200 border border-gray-200 rounded-lg shadow hover:bg-red-300 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        ...
                        <p class="font-normal text-gray-700 dark:text-gray-400">{{ $attedance != null && $attedance->home_time != null ? $attedance->home_time : 'Belum Absen' }}</p>
                    </a>
                </div>
            </div>
            ...
            <div class="mt-5 border-t-2 border-zinc-100 w-full">
                <div class="flex items-center justify-around space-x-4 mt-5">
                    <a href="{{ route('leave.create') }}" class="flex-col items-center px-4 py-2 text-sm font-medium text-center text-black bg-zinc-200 rounded-lg hover:bg-zinc-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    ...
                    <a href="{{ route('history') }}" class="flex-col items-center px-4 py-2 text-sm font-medium text-center text-black bg-zinc-200 rounded-lg hover:bg-zinc-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        <svg class="w-[30px] h-[30px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none" viewBox="0 0 24 24">

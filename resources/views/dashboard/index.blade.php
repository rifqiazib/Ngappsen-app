        ...
        <div class="mt-4 w-full p-6 bg-zinc-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="mt-5 border-t-2 border-zinc-100 w-full">
                <div class="flex items-center justify-around space-x-4 mt-5">
                    <a href="{{ route('leave') }}" class="flex-col items-center px-4 py-2 text-sm font-medium text-center text-black bg-zinc-200 rounded-lg hover:bg-zinc-300 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">

    ...
    <div class="p-4 sm:ml-64">
                                ...
                                <div id="edit-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <!-- Modal body -->
                                            <form method="POST" action="{{ route('department.update') }}" class="p-4 md:p-5">
                                                @csrf
                                                @method('PUT')
                                                ...
                                                <div class="grid gap-4 mb-4 grid-cols-2">
                                                    <div class="col-span-2">
                                                        <label for="code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Code</label>
                                                        <input type="text" name="code" id="edit-code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                                                    </div>
                                                    <div class="col-span-2">
                                                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <div class="flex justify-center items">
                                                    <form id="delete-form" action="{{ route('department.delete', ['id' => $department->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
        ...
        <div class="flex flex-col items-center mt-4">
            ...
            <span class="text-sm text-gray-700 dark:text-gray-400">
                Showing <span class="font-semibold text-gray-900 dark:text-white">{{ $departments->firstItem() }}</span> 
                to <span class="font-semibold text-gray-900 dark:text-white">{{ $departments->lastItem() }}</span> 
                of <span class="font-semibold text-gray-900 dark:text-white">{{ $departments->total() }}</span> Entries
            </span>
            <!-- Buttons -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('[data-modal-target="popup-modal"]').on('click', function() {
                ...
                $('#delete-form').attr('action', '/department/delete/' + departmentId);
